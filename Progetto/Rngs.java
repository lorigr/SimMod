 ...
 */
  ...
  public double negExp(double n){
    double u;
    u = random();
    return -n * Math.log(1-u);
  }
  ...
  public double hyperExp(double a, double b, double m1, double m2){
    double selection = Uniform(0, 1);
    double random = 0;
    if(selection<=a){
        random = negExp(m1);
    }else{
 ...
 */
  public void testRandom() {
    ...
    double sum =0;
    for(i=1; i<=20; i++){
      sum+=(hyperExp(0.95, 0.05, 60, 2860));
    }
    ...
    selectStream(2);
    for(i=0; i<10; i++){
      System.out.println(negExp(7.14285714));
    }*/
